...
const FAQ = () => {
  ...
  const faqData: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "Temporary emails generated by BravoMail are valid for 60 minutes from creation. After this time, the email address and all associated messages are permanently deleted from our servers. This ensures maximum privacy and security for our users.",
      category: "general"
    },
    {
    ...
    },
    {
      ...
      answer: "No, temporary emails cannot be extended beyond the 60-minute limit. This is a deliberate security feature to ensure maximum privacy. If you need a longer-lasting email, simply generate a new temporary email address when needed.",
      category: "technical"
    },
    {
    ...
    {
      question: "What happens to my emails after 60 minutes?",
      answer: "After 60 minutes, both the temporary email address and all emails received at that address are permanently deleted from our servers. This data cannot be recovered by anyone, including our team. This automatic deletion ensures your privacy is protected.",
      category: "privacy"
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, your email content is private during the 60-minute lifespan. Emails are stored securely on our servers with encryption in transit. However, remember that emails are automatically deleted after 60 minutes, so save any important information before the expiry time.",
      category: "privacy"
    },
    {
