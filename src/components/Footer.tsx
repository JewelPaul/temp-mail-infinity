        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-muted-foreground hover:text-primary transition-smooth p-2 min-h-[44px] min-w-[44px] flex items-center justify-center">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm sm:text-base text-muted-foreground hover:text-primary transition-smooth py-1 block">Home</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm sm:text-base text-muted-foreground hover:text-primary transition-smooth py-1 block">Privacy Policy</a></li>
              <li><a href="#" className="text-sm sm:text-base text-muted-foreground hover:text-primary transition-smooth py-1 block">Terms of Service</a></li>
              <li><a href="#" className="text-sm sm:text-base text-muted-foreground hover:text-primary transition-smooth py-1 block">Cookie Policy</a></li>
              <li><a href="#" className="text-sm sm:text-base text-muted-foreground hover:text-primary transition-smooth py-1 block">GDPR</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm sm:text-base text-muted-foreground hover:text-primary transition-smooth py-1 block">Contact Us</a></li>
